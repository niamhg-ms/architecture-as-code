...
db.schemas.insertMany([
    // Insert initial documents into the schemas collection
    {
        version: '2024-10',
        schemas: {
            'calm.json': {
            ...
            'flow.json': {
                ...
                description:
                    'Defines business flows that relate to technical architectures, allowing mapping of flows to technical components and attaching control requirements.',
                type: 'object',
                properties: {
                    'unique-id': {
                        type: 'string',
            ...
            'interface.json': {
                ...
                defs: {
                    ...
                    'rate-limit-interface': {
                        ...
                        required: ['key', 'time', 'time-unit', 'calls'],
                    },
                    'rate-limit-key': {
                        type: 'object',
                        properties: {
            ...
            'units.json': {
                ...
                defs: {
                    'time-unit': {
                        type: 'object',
                        description:
                            'A unit of time with a value and a unit type.',
                        properties: {
                            unit: {
                                enum: [
                                    'nanoseconds',
                    ...
                    'cron-expression': {
                        ...
                        pattern:
                            '^([0-5]?\\d)\\s([01]?\\d|2[0-3])\\s(3[01]|[12]\\d|0?[1-9])\\s(1[0-2]|0?[1-9])\\s([0-6])$',
                        examples: ['0 0 * * 0', '30 14 1 * 5', '15 10 * * *'],
                    },
                },
                additionalProperties: false,
            },
        ...
        patterns: [
            {
                ...
                versions: {
                    '1-0-0': {
                        $schema:
                            'https://raw.githubusercontent.com/finos/architecture-as-code/main/calm/draft/2024-04/meta/calm.json',
        ...
        patterns: [
            {
                ...
                versions: {
                    '1-0-0': {
                        ...
                        description:
                            'A reusable architecture pattern for conference signup systems with Kubernetes deployment.',
                        properties: {
                            nodes: {
                                type: 'array',
                                minItems: 5,
            ...
            },
            {
                ...
                versions: {
                    '1-0-0': {
                        ...
                        description:
                            'A secure reusable architecture pattern for conference signup systems with Kubernetes deployment.',
                        properties: {
                            nodes: {
                                type: 'array',
                                minItems: 5,
        ...
        flows: [
            {
                ...
                versions: {
                    '1-0-0': {
                        ...
                        title: 'Flow 1',
                        description:
                            'This is a non-compliant flow document. Just creating something to simulate',
                    },
                },
            },
            {
                ...
                versions: {
                    '1-0-0': {
                        ...
                        transitions: [
                            {
                                'relationship-unique-id':
                                    'web-gui-process-uses-accounts-service',
                                'sequence-number': 1,
                                summary: 'Submit Account Create/Update',
                            },
                            {
                                'relationship-unique-id':
                                    'accounts-service-uses-traderx-db-for-accounts',
                                'sequence-number': 2,
                            ...
                            },
                            {
                                ...
                                'sequence-number': 3,
                                summary:
                                    'Returns Account Create/Update Response Status',
                        ...
                        controls: {
                            'add-update-account-sla': {
                                ...
                                requirements: [
                                    {
                                        'control-requirement-url':
                                            'https://calm.finos.org/samples/traderx/controls/flow-sla-control-requirement.json',
                                        'control-config':
                                            'https://calm.finos.org/samples/traderx/flows/add-update-account/add-update-account-control-configuration.json',
                                    },
                                ],
                            },
                        },
        ...
        architectures: [
            {
                ...
                versions: {
                    '1-0-0': {
                        ...
                        description:
                            'This is a non-compliant arch document. Just creating something to simulate',
                    },
                },
            },
        ],
                ...
                versions: {
                    '1-0-0': {
                        ...
                        relationships: [
                            ...
                            {
                                'unique-id':
                                    'attendees-service-attendees-store',
                                description:
                    ...
                    '1-0-0': {
                        ...
                        relationships: [
                            ...
                            },
                            {
                                ...
                                description:
                                    'Web client interacts with the Web GUI process.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'web-client',
                            ...
                            {
                                'unique-id':
                                    'web-gui-uses-position-service-for-position-queries',
                            ...
                            {
                                'unique-id':
                                    'web-gui-uses-position-service-for-trade-queries',
                            ...
                            {
                                'unique-id':
                                    'position-service-uses-traderx-db-for-positions',
                                description:
                                    'Looks up default positions for a given account.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'position-service',
                            ...
                            {
                                'unique-id':
                                    'position-service-uses-traderx-db-for-trades',
                                description:
                                    'Looks up all trades for a given account.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'position-service',
                            ...
                            {
                                'unique-id':
                                    'web-gui-process-uses-reference-data-service',
                                description:
                                    'Looks up securities to assist with creating a trade ticket.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'web-gui-process',
                            ...
                            {
                                'unique-id':
                                    'web-gui-process-uses-trading-services',
                                description:
                                    'Creates new trades and cancels existing trades.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'web-gui-process',
                            ...
                            },
                            {
                                ...
                                description:
                                    'Subscribes to trade/position updates feed for currently viewed account.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'web-gui-process',
                            ...
                            {
                                'unique-id':
                                    'trade-processor-connects-to-trade-feed',
                                description:
                                    'Processes incoming trade requests, persist and publish updates.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                            ...
                            {
                                'unique-id':
                                    'trade-processor-connects-to-traderx-db',
                                description:
                                    'Looks up current positions when bootstrapping state, persist trade state and position state.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'trade-processor',
                            ...
                            },
                            {
                                'unique-id':
                                    'web-gui-process-uses-accounts-service',
                                description:
                                    'Creates/Updates accounts. Gets list of accounts.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'web-gui-process',
                            ...
                            {
                                'unique-id':
                                    'web-gui-process-uses-people-service',
                                description:
                                    'Looks up people data based on typeahead from GUI.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'web-gui-process',
                            ...
                            {
                                'unique-id':
                                    'people-service-connects-to-user-directory',
                            ...
                            {
                                'unique-id':
                                    'trading-services-connects-to-reference-data-service',
                                description:
                                    'Validates securities when creating trades.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'trading-services',
                            ...
                            },
                            {
                                ...
                                description:
                                    'Publishes updates to trades and positions after persisting in the DB.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'trading-services',
                            ...
                            {
                                'unique-id':
                                    'trading-services-uses-account-service',
                                description:
                                    'Validates accounts when creating trades.',
                                'relationship-type': {
                                    connects: {
                                        source: {
                                            node: 'trading-services',
